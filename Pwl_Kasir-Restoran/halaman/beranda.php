...
<form action="beranda1.php#menu" method="GET" class="form-inline d-flex">
  <!-- Input Pencarian -->
  <input class="form-control mx-sm-2" type="search" autocomplete="off" name="key-search" placeholder="Cari..." style="width: auto; max-width: 250px;">
...
<form action="beranda1.php#menu" method="POST">
